...
namespace PostureCreator
{
    ...
    {
        private CustomJoint baseJoint, legJointOne, legJointTwo;
        ...
        public CustomJoint getLegJointOne()
        {
            return legJointOne;
        }
        ...
        public CustomJoint getLegJointTwo()
        {
            return legJointTwo;
        }
        ...
        /// </summary>
        /// <returns>legJointTwo</returns>
        public CustomJoint getBaseJoint()
        {
            return baseJoint;
        }
    }
