...
namespace PostureCreator
{
    ...
    public class CustomJoint
    {
        ...
        /// </summary>
        /// <param name="name">The name of the joint. Identical to the Joints of the kinect-sdk.</param>
        ...
        public CustomJoint(String name, Canvas c, double x, double y, Window win)
        {
            currentX = x;
            currentY = y;
            this.name = name;
        ...
        /// <summary>
        /// Getter for the name. Should be a Joint according to the kinect-sdk.
        /// </summary>
        /// <returns></returns>
